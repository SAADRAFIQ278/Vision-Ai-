...
(function() {
    ...
    // ============================================
    // 2. MODEL STATS COUNTER
    // ============================================

    function initModelStats() {
        const stats = document.querySelectorAll('.model-stat-box .stat-number');
        ...
        const container = stats[0].closest('.model-stats-grid');
        if (container) {
    ...
    // ============================================
    // 3. MODEL COMPARISON TABLE INTERACTIVITY
    // ============================================
    ...
    // ============================================
    // 4. SMOOTH SCROLL TO MODEL (from anchor links)
    // ============================================
    ...
    // ============================================
    // 5. MODEL FILTER (Optional for future expansion)
    // ============================================
